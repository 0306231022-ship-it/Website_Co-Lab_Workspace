...
nguoidungRouter.post(
  "/CapNhat_TrangThai",
  upload.none(),
  NguoiDungController.ChinhSua_TrangThai_NguoiDung,
);
nguoidungRouter.post(
  "/ChinhSua_thongTin",
  upload.none(),
  verifyToken,
  NguoiDungController.ChinhSua_NguoiDung,
);
nguoidungRouter.post(
  "/ChinhSua_Anh",
  createUpload("DaiDien").any(),
  verifyToken,
  NguoiDungController.CapNhat_anhDaiDien,
);
nguoidungRouter.post(
  "/kiemtra_dangnhap",
  upload.none(),
  verifyToken,
  NguoiDungController.ThongTin_NguoiDung,
);
nguoidungRouter.post(
  "/dangxuat",
  upload.none(),
  verifyToken,
  NguoiDungController.DangXuat,
);
//=========================================
...
nguoidungRouter.get(
  "/lichsu_datlich",
  verifyToken,
  LichDatController.LichSuDat_theoIDND,
);
nguoidungRouter.get(
  "/lichsu_datlich_nguoidung",
  LichDatController.LichSuDat_theoIDND,
);
nguoidungRouter.get(
  "/lich-dat",
  verifyToken,
  LichDatController.ChiTiet_LichDat_theoIDDL,
);
...
nguoidungRouter.get(
  "/layDS_thongbao",
  verifyToken,
  thongBaoController.getThongBaoByUser,
);
nguoidungRouter.post(
  "/XoaTheoid",
  upload.none(),
  thongBaoController.deleteThongBao,
);
nguoidungRouter.post(
  "/XoaTatCa",
  upload.none(),
  verifyToken,
  thongBaoController.deleteAllThongBaoByUserId,
);
// hóa đơn
